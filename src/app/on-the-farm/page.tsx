...
export default function OnTheFarmPage() {
  return (
    <div className="min-h-screen bg-white text-[#252525]">
      ...
      <header className="relative w-full py-20 px-6 bg-[#FAF9F6] border-b border-gray-200 text-center overflow-hidden">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex justify-center">
            <div className="w-20 h-20 rounded-full bg-[#FEEF30] border-2 border-[#252525] p-2 flex items-center justify-center shadow-md">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <h2 className="text-3xl sm:text-5xl font-black lowercase tracking-tight text-[#252525] font-serif">
            meet our farmers
          </h2>
          ...
          {FARMERS.map((farmer, idx) => (
            ...
            >
              <div className="relative w-full h-64 overflow-hidden bg-gray-100">
                ...
                />
                <div className="absolute bottom-3 left-3 bg-white/95 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-[#252525] shadow">
                  {farmer.location}
                </div>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  <h3 className="text-xl font-bold text-[#252525] font-serif">{farmer.name}</h3>
                  <div className="flex items-center gap-2 text-xs text-[#75791B] font-bold mt-1">
                ...
                <div className="pt-4 border-t border-gray-100">
                  <span className="text-[11px] font-bold text-[#43670F] uppercase tracking-wider flex items-center gap-1">
      ...
      <section className="py-20 px-6 bg-[#EEEEEE] border-y border-gray-200">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-[#252525] font-bebas">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {PRACTICES.map((p, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-white p-7 rounded-2xl border border-gray-200 shadow-sm space-y-4 flex flex-col justify-between"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#FEEF30] flex items-center justify-center text-[#252525]">
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-[#252525] font-serif">{p.title}</h3>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            <span className="w-10 h-10 rounded-full bg-[#43670F] text-white font-bold flex items-center justify-center mx-auto text-sm">
              1
            </span>
            <h4 className="font-bold text-base text-[#252525]">Gentle Milking</h4>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            ...
            <h4 className="font-bold text-base text-[#252525]">Immediate 4°C Chilling</h4>
            <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            ...
            <h4 className="font-bold text-base text-[#252525]">Glass Bottle Sealing</h4>
            <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            ...
            <h4 className="font-bold text-base text-[#252525]">Strict OTP Handover</h4>
            <p className="text-xs text-gray-600 leading-relaxed">
        ...
        <div className="text-center pt-8">
          <Link
            href="/menu"
            className="inline-flex items-center gap-2 btn-motive px-10 py-4 rounded-full text-sm font-bold uppercase tracking-wider shadow-lg hover:shadow-xl transition transform hover:scale-105"
          >
            <ShoppingBag className="w-4 h-4" />
            <span>Order Pure Farm Milk & Goods Now</span>
          </Link>
        </div>
      </section>
    </div>
